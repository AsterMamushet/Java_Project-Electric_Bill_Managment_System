...
public class new_connection extends loginConntroller implements Initializable {
    ...
    public void save_to_db() {
        try {
            BufferedReader bufferedReader = new BufferedReader(new FileReader("/home/nahom/Downloads/Electricity-Bill-Management-System-Projects/ESMS App admin/src/main/c_id_text/c_id.txt"));
            int c_id;
            c_id = Integer.parseInt(bufferedReader.readLine());
            System.out.println(c_id);
            c_id++;
            bufferedReader.close();
            BufferedWriter bufferedWriter = new BufferedWriter(new FileWriter("/home/nahom/Downloads/Electricity-Bill-Management-System-Projects/ESMS App admin/src/main/c_id_text/c_id.txt"));
